...
\begin{figure}[!htbp]
\centering
\includegraphics[width=1\textwidth]{fig_3_1_prix_m2_log.png}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=1\textwidth]{fig_3_2_intensite_vente.png}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.95\textwidth]{fig_3_3_distribution_variation_marge.png}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.95\textwidth]{fig_3_4_scenarios_taux_2026.png}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.95\textwidth]{fig_3_5_courbes_logistiques.png}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.88\textwidth]{fig_3_6_effet_millesime.png}
\caption{Effet millésime du modèle de prix : prime par année de réservation, référence 2016}
\end{figure}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.88\textwidth]{fig_3_7_stock_prix_marche.png}
\caption{Stock d'appartements : prix de grille contre prix de marché estimé, avec la bande à plus ou moins une erreur type}
\end{figure}
...
La page \textbf{Vue d'ensemble}, présentée en Figure 3.8, donne la situation en quelques secondes :
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=1\textwidth]{fig_3_8_plateforme_vue_ensemble.png}
\caption{Plateforme, page «~Vue d'ensemble~»}
\end{figure}

La page \textbf{Alertes marge}, présentée en Figure 3.9, classe les opérations par niveau
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=1\textwidth]{fig_3_9_plateforme_alertes_marge.png}
