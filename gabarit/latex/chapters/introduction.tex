...
parce que rien de ce qui suit ne se comprend si on les confond. L'\textbf{aménagement foncier}
...
sont l'acquisition et les travaux de voirie et réseaux. La \textbf{promotion immobilière} consiste à
...
\textbf{Grimmo}, l'ERP métier historique, portait la gestion des opérations~; \textbf{Vadimm}, le CRM,
portait la relation commerciale, acquéreurs, réservations, désistements et coordonnées~;
\textbf{MyReport}, l'outil décisionnel, requêtait les bases sources et produisait les tableaux de
bord~; et \textbf{les tableurs}, enfin, faisaient le lien partout où les trois premiers ne se
