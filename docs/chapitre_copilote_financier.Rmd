...
Perpignan, Aix, Salon-de-Provence), filiale du groupe Nexity. Son activité se
...
2. **À quel rythme le stock va-t-il s'écouler ?** Le rythme de réservation
   ...
   1,1 % à environ 4 % entre 2022 et 2024 a donné une illustration brutale de
   ce lien, avec un effondrement visible du rythme de vente sur la même
   période.
...
le libre) et une élasticité-taille négative (−3,1 % par doublement de
surface, la demande de petites surfaces étant plus dense). L'effet millésime
