...
notre CRM Vadimm vers le nouvel ERP du groupe, SPO. Cette mission, conduite au second
semestre, prolonge directement le chantier de migration exposé dans mon mémoire de
mi-parcours, et elle répond au chantier d'interopérabilité entre l'ERP et le CRM que j'y
annonçais. Elle en change toutefois la nature : il ne s'agissait plus d'injecter des structures de gestion, opérations,
...
immobilières et de leurs tranches, il restait à reprendre les données commerciales, et en
premier lieu les clients. Dans SPO (Suivi des Programmes Opérationnels), ces clients sont
...
par objet rattaché. Six d'entre eux correspondent aux six feuilles de sortie de mon fichier,
les deux autres, les RIB et les sites web, n'étant pas alimentés par cette reprise.
...
![De 1 602 lignes de départ à 1 434 tiers créés : l'effet des deux filtres successifs](figures/fig_1_3_entonnoir_volumetrie.png){width=92%}
...
approximations : ils sont la traduction directe du modèle de données décrit en 1.2.2.
...
> Masquer l'adresse du serveur et les identifiants, comme sur la Figure 1.2. Les figures
...
démontrer plutôt que de l'affirmer. Le chapitre suivant présente le projet auquel ce
travail de structure ouvrait la voie : le Copilote Financier, un outil d'aide à la décision construit sur les
