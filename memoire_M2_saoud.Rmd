...
Le travail commence rarement par une spécification. Il commence par une phrase du type «
on n'arrive pas à savoir combien on a facturé sur cette opération », ou par un tableau que
...
avec nos logiciels existants. En effet, je faisais face à des contraintes techniques
fortes qui limitaient mes options :
...
pas. Cependant, ces contournements auront rendu un service précis : ils ont maintenu le
...
doublon, et elle a réalisé l'interopérabilité entre l'ERP et le CRM qui restait à faire.
