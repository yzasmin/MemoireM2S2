...
fois, dans la vue, et les notebooks comme la plateforme consomment la même. J'avais
rencontré la difficulté inverse sur les reportings du premier semestre, exposés dans mon
mémoire de mi-parcours : faute de pouvoir écrire une règle de gestion quelque part une fois
pour toutes, il fallait la recalculer à chaque génération du tableau.
