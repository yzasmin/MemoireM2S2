...
données de gestion du groupe Angelotti pour sa direction financière. Le périmètre annoncé
alors a été redéfini en cours de projet : la prédiction de la marge à terminaison subsiste
...
fois, dans la vue, et les notebooks comme la plateforme consomment la même. C'est la
situation inverse de celle que décrit mon mémoire de mi-parcours, où la règle de gestion,
ne pouvant être écrite nulle part, devait être recalculée à chaque génération du tableau.
...
théorique, devient presque rectiligne. La Figure 2.1 rassemble les deux distributions et
...
Figure 2.3 donne la distribution complète et situe ce seuil, avec à droite le détail des
opérations en dérive.

![Distribution de la variation de marge « committée » sur les 123 opérations du périmètre, et seuil de dérive matérielle à -2 %](figures/fig_2_3_distribution_variation_marge.png){width=95%}
...
deux recommandations de ce chapitre, historiser les exports mensuels et fiabiliser la
saisie des motifs de désistement, sont exactement de la même nature que le travail décrit
au chapitre 1. Ce sont des travaux de structure, faits pour rendre possible une
analyse à venir.

Cette année d'alternance m'aura donc fait parcourir un cycle complet. Le premier semestre a
été celui de l'ingénierie des données, avec la migration des opérations vers SPO et sa
stratégie de déploiement en coquilles vides. La reprise des tiers, exposée au chapitre 1,
l'a prolongée au second semestre : elle a achevé de constituer le socle commercial du
nouvel outil, et elle a réalisé le chantier d'interopérabilité entre l'ERP et le CRM que
j'annonçais en fin de mémoire de mi-parcours. Le second semestre aura donc été celui de la
valorisation autant que celui de l'achèvement du socle, avec un projet de Data Science mené
de bout en bout, de la compréhension des exports jusqu'à une application destinée à la
...
chose. Le métier de gestionnaire d'information, tel que je l'ai pratiqué cette année,
consiste largement à prendre ces décisions-là, à les écrire, et à les rendre vérifiables
par d'autres.
...
suivi que lorsque les exports auront été historisés sur une durée suffisante. Ce que cette
année aura établi ne dépend pourtant pas de ces échéances : structurer une donnée et la
modéliser ne sont pas deux métiers successifs, mais deux moments du même travail, et c'est
le premier qui décide de ce que le second pourra en tirer.
